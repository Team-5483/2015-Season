...
import org.usfirst.frc.team5483.auton.mode.MiddleBin1;
import org.usfirst.frc.team5483.auton.mode.TwoRCOwnSide;
...
public class AutonControl {
	 private static AutonControl instance;
		...
		private AutonControl() {
	        ...
	        this.autonModes.addElement(new MiddleBin1());//1
	        this.autonModes.addElement(new TwoRCOwnSide());//2
